...
export const signatureStories: SignatureStory[] = [
  ...
  },
  {
    ...
    bodyLong: [
      ...
      "My role wasn't to own a single module. It was to own the blocking risk — to keep the go-live on its feet by finding and solving every showstopper bug across a team of consultants working in parallel. That's a different job than senior consultant on a project. It requires assimilating a lot of complex context — schema decisions, customization scope, integration touchpoints, data-migration state, outstanding defects — from multiple consultants, each of whom has their own partial view of the engagement. And it requires spotting the solutions other people on the team haven't.",
      "The discipline was triage. Every day, I'd read the current state of the engagement from the people doing the work, identify what would block go-live if left in place, and decide what to attack that day. Some blockers were module-level bugs that needed a specific change. Some were integration issues between pieces the consultants hadn't yet reconciled. Some were scope decisions that needed to be made and committed to, so the team could stop circling them. The constant pressure was time — every day spent on the wrong blocker was a day the date got closer without the right one being solved.",
  ...
  },
  {
    ...
    problemHeadline:
      "A custom wood furniture manufacturer couldn't manufacture or ship. Severe SQL Server corruption had taken out their key SAP tables — ten years of transaction history, effectively unreadable.",
    clientDescriptor:
      'A custom wood furniture manufacturer in North America. ~5 million transactions across 10 years of operations. Rebuilt in roughly two weeks.',
    bodyShort:
      "A custom wood furniture manufacturer lost access to ten years of transaction history when severe SQL Server corruption took out their key SAP tables. Without the data, they couldn't manufacture or ship. I had roughly two weeks to rebuild it. Reading the corrupted tables directly wasn't possible, so I wrote a DI API system that reconstructed every transaction — roughly five million of them — from the surrounding tables that had survived. The new SAP company has been live for a year without an issue.",
    bodyLong: [
      ...
      'The reconstruction ran across roughly five million transactions covering ten years of the customer\'s operations. The cutover was delivered in about two weeks from the day I was called in. The new system has been live for a year and continues to run, without an issue — the closest thing to proof you can offer that a reconstruction of this kind was done correctly.',
    ],
    outcome:
      '~5 million transactions reconstructed in two weeks. Live for a year on the new system without an issue.',
    scale: '~5M transactions · 10 years of history · rebuilt in ~2 weeks',
  },
];
